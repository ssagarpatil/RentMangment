...
public class Tenant {
    ...
    public String email;
    public String roomNumber;
    public String assignedRoomKey;    // NEW: Firebase key of assigned room
    public String assignedRoomName;   // NEW: Display name of assigned room
    public String leaseStart;
    public String leaseEnd;
    public double rentAmount;
    public double securityDeposit;
    ...
    public Tenant(String tenantId, String name, String mobile, String email,
                  ...
                  String leaseStart, String leaseEnd, double rentAmount, double securityDeposit,
                  String paymentStatus, String emergencyContactName, String emergencyContactPhone,
                  String idProofType, String idProofNumber, String notes, String photoUrl) {
        this.tenantId = tenantId;
        this.name = name;
        this.mobile = mobile;
